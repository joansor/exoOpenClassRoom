...
const port = normalizePort(process.env.PORT || '3000'); // prend tous les ports ou le port 3000,  renvoie un port valide, qu'il soit fourni sous la forme d'un numéro ou d'une chaîne ;
app.set('port', port);
